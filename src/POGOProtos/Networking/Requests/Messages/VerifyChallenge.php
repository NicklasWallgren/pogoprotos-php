...
//   require('POGOProtos/Networking/Requests/Messages/VerifyChallenge.php');
...
namespace POGOProtos\Networking\Requests\Messages {
  ...
  // message POGOProtos.Networking.Requests.Messages.VerifyChallengeMessage
  final class VerifyChallengeMessage extends ProtobufMessage {

    private $_unknown;
    private $token = ""; // optional string token = 1
    ...
    public function read($fp, &$limit = PHP_INT_MAX) {
      ...
      while(!feof($fp) && $limit > 0) {
        ...
        $field = $tag >> 3;
        switch($field) {
          case 1: // optional string token = 1
            if($wire !== 2) {
