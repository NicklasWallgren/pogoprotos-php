...
namespace POGOProtos\Networking\Responses {
  ...
  final class FortDetailsResponse extends ProtobufMessage {
    ...
    private $teamColor = \POGOProtos\Enums\TeamColor::NEUTRAL; // optional .POGOProtos.Enums.TeamColor team_color = 2
    ...
    public function write($fp) {
      ...
      if ($this->teamColor !== \POGOProtos\Enums\TeamColor::NEUTRAL) {
        fwrite($fp, "\x10", 1);
    ...
    public function clearTeamColor() { $this->teamColor = \POGOProtos\Enums\TeamColor::NEUTRAL; }
    ...
    public function __toString() {
      return ''
           ...
           . Protobuf::toString('team_color', $this->teamColor, \POGOProtos\Enums\TeamColor::NEUTRAL)
