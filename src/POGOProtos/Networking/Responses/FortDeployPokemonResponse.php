...
namespace POGOProtos\Networking\Responses {
  ...
  final class FortDeployPokemonResponse extends ProtobufMessage {
    ...
    private $_unknown;
    private $result = \POGOProtos\Networking\Responses\FortDeployPokemonResponse_Result::NO_RESULT_SET; // optional .POGOProtos.Networking.Responses.FortDeployPokemonResponse.Result result = 1
    ...
    public function write($fp) {
      if ($this->result !== \POGOProtos\Networking\Responses\FortDeployPokemonResponse_Result::NO_RESULT_SET) {
        fwrite($fp, "\x08", 1);
    ...
    public function clearResult() { $this->result = \POGOProtos\Networking\Responses\FortDeployPokemonResponse_Result::NO_RESULT_SET; }
    ...
    public function __toString() {
      return ''
           . Protobuf::toString('result', $this->result, \POGOProtos\Networking\Responses\FortDeployPokemonResponse_Result::NO_RESULT_SET)
