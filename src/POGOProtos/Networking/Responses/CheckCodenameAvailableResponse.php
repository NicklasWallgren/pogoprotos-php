...
//   require('POGOProtos/Networking/Responses/CheckCodenameAvailableResponse.php');
...
namespace POGOProtos\Networking\Responses {
  ...
  final class CheckCodenameAvailableResponse extends ProtobufMessage {
      ...
      while(!feof($fp) && $limit > 0) {
        ...
        switch($field) {
          ...
          case 3: // optional bool is_assignable = 3
            ...
            break;
          case 4: // optional .POGOProtos.Networking.Responses.CheckCodenameAvailableResponse.Status status = 4
            if($wire !== 0) {
              throw new \Exception("Incorrect wire format for field $field, expected: 0 got: $wire");
            }
            $tmp = Protobuf::read_varint($fp, $limit);
