...
namespace POGOProtos\Networking\Responses {
  ...
  final class FortRecallPokemonResponse extends ProtobufMessage {
    ...
    private $_unknown;
    private $result = \POGOProtos\Networking\Responses\FortRecallPokemonResponse_Result::NO_RESULT_SET; // optional .POGOProtos.Networking.Responses.FortRecallPokemonResponse.Result result = 1
    ...
    public function write($fp) {
      if ($this->result !== \POGOProtos\Networking\Responses\FortRecallPokemonResponse_Result::NO_RESULT_SET) {
        fwrite($fp, "\x08", 1);
    ...
    public function clearResult() { $this->result = \POGOProtos\Networking\Responses\FortRecallPokemonResponse_Result::NO_RESULT_SET; }
    ...
    public function __toString() {
      return ''
           . Protobuf::toString('result', $this->result, \POGOProtos\Networking\Responses\FortRecallPokemonResponse_Result::NO_RESULT_SET)
