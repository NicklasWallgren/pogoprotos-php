...
namespace POGOProtos\Networking\Responses {
  ...
  final class UseItemReviveResponse extends ProtobufMessage {
    ...
    private $_unknown;
    private $result = \POGOProtos\Networking\Responses\UseItemReviveResponse_Result::NONE; // optional .POGOProtos.Networking.Responses.UseItemReviveResponse.Result result = 1
    ...
    public function write($fp) {
      if ($this->result !== \POGOProtos\Networking\Responses\UseItemReviveResponse_Result::NONE) {
        fwrite($fp, "\x08", 1);
    ...
    public function clearResult() { $this->result = \POGOProtos\Networking\Responses\UseItemReviveResponse_Result::NONE; }
    ...
    public function __toString() {
      return ''
           . Protobuf::toString('result', $this->result, \POGOProtos\Networking\Responses\UseItemReviveResponse_Result::NONE)
