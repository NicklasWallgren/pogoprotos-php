...
//   require('POGOProtos/Networking/Responses/UseItemReviveResponse.php');
...
namespace POGOProtos\Networking\Responses {
  ...
  // enum POGOProtos.Networking.Responses.UseItemReviveResponse.Result
  abstract class UseItemReviveResponse_Result extends ProtobufEnum {
    const UNSET = 0;
    const SUCCESS = 1;
  ...
  final class UseItemReviveResponse extends ProtobufMessage {

    private $_unknown;
    private $result = \POGOProtos\Networking\Responses\UseItemReviveResponse_Result::UNSET; // optional .POGOProtos.Networking.Responses.UseItemReviveResponse.Result result = 1
    ...
    public function read($fp, &$limit = PHP_INT_MAX) {
      ...
      while(!feof($fp) && $limit > 0) {
        ...
        $field = $tag >> 3;
        switch($field) {
          case 1: // optional .POGOProtos.Networking.Responses.UseItemReviveResponse.Result result = 1
            if($wire !== 0) {
    ...
    public function write($fp) {
      if ($this->result !== \POGOProtos\Networking\Responses\UseItemReviveResponse_Result::UNSET) {
        fwrite($fp, "\x08", 1);
    ...
    public function clearResult() { $this->result = \POGOProtos\Networking\Responses\UseItemReviveResponse_Result::UNSET; }
    ...
    public function __toString() {
      return ''
           . Protobuf::toString('result', $this->result, \POGOProtos\Networking\Responses\UseItemReviveResponse_Result::UNSET)
