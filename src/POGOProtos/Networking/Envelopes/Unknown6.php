...
namespace POGOProtos\Networking\Envelopes {
  ...
  final class Unknown6 extends ProtobufMessage {
    ...
    private $_unknown;
    private $requestType = 0; // optional int32 request_type = 1
    ...
    public function read($fp, &$limit = PHP_INT_MAX) {
      ...
      while(!feof($fp) && $limit > 0) {
        ...
        $field = $tag >> 3;
        switch($field) {
          case 1: // optional int32 request_type = 1
            if($wire !== 0) {
              throw new \Exception("Incorrect wire format for field $field, expected: 0 got: $wire");
            }
            $tmp = Protobuf::read_signed_varint($fp, $limit);
            if ($tmp === false) throw new \Exception('Protobuf::read_varint returned false');
            if ($tmp < Protobuf::MIN_INT32 || $tmp > Protobuf::MAX_INT32) throw new \Exception('int32 out of range');$this->requestType = $tmp;
    ...
    public function clearRequestType() { $this->requestType = 0; }
    ...
    public function __toString() {
      return ''
           . Protobuf::toString('request_type', $this->requestType, 0)
