...
namespace POGOProtos\Networking\Envelopes {
  ...
  // message POGOProtos.Networking.Envelopes.Unknown6Response.Unknown2.StoreItem.Tag
  final class Unknown6Response_Unknown2_StoreItem_Tag extends ProtobufMessage {
  ...
  // message POGOProtos.Networking.Envelopes.Unknown6Response.Unknown2.StoreItem
  final class Unknown6Response_Unknown2_StoreItem extends ProtobufMessage {
    ...
    private $tags = array(); // repeated .POGOProtos.Networking.Envelopes.Unknown6Response.Unknown2.StoreItem.Tag tags = 6
      ...
      while(!feof($fp) && $limit > 0) {
        ...
        switch($field) {
          ...
          case 5: // optional .POGOProtos.Inventory.Item.ItemData yields_item = 5
            ...
            break;
          case 6: // repeated .POGOProtos.Networking.Envelopes.Unknown6Response.Unknown2.StoreItem.Tag tags = 6
            if($wire !== 2) {
              throw new \Exception("Incorrect wire format for field $field, expected: 2 got: $wire");
            }
            $len = Protobuf::read_varint($fp, $limit);
            if ($len === false) throw new \Exception('Protobuf::read_varint returned false');
            $limit -= $len;
            $this->tags[] = new \POGOProtos\Networking\Envelopes\Unknown6Response_Unknown2_StoreItem_Tag($fp, $len);
            if ($len !== 0) throw new \Exception('new \POGOProtos\Networking\Envelopes\Unknown6Response_Unknown2_StoreItem_Tag did not read the full length');
  ...
  final class Unknown6Response_Unknown2 extends ProtobufMessage {
    ...
    private $items = array(); // repeated .POGOProtos.Networking.Envelopes.Unknown6Response.Unknown2.StoreItem items = 2
      ...
      while(!feof($fp) && $limit > 0) {
        ...
        switch($field) {
          case 1: // optional uint64 unknown1 = 1
            ...
            break;
          case 2: // repeated .POGOProtos.Networking.Envelopes.Unknown6Response.Unknown2.StoreItem items = 2
            if($wire !== 2) {
              throw new \Exception("Incorrect wire format for field $field, expected: 2 got: $wire");
            }
            $len = Protobuf::read_varint($fp, $limit);
            if ($len === false) throw new \Exception('Protobuf::read_varint returned false');
            $limit -= $len;
            $this->items[] = new \POGOProtos\Networking\Envelopes\Unknown6Response_Unknown2_StoreItem($fp, $len);
            if ($len !== 0) throw new \Exception('new \POGOProtos\Networking\Envelopes\Unknown6Response_Unknown2_StoreItem did not read the full length');
  ...
  final class Unknown6Response extends ProtobufMessage {
    ...
    private $_unknown;
    private $responseType = 0; // optional int32 response_type = 1
    ...
    public function read($fp, &$limit = PHP_INT_MAX) {
      ...
      while(!feof($fp) && $limit > 0) {
        ...
        $field = $tag >> 3;
        switch($field) {
          case 1: // optional int32 response_type = 1
            if($wire !== 0) {
              throw new \Exception("Incorrect wire format for field $field, expected: 0 got: $wire");
            }
            $tmp = Protobuf::read_signed_varint($fp, $limit);
            if ($tmp === false) throw new \Exception('Protobuf::read_varint returned false');
            if ($tmp < Protobuf::MIN_INT32 || $tmp > Protobuf::MAX_INT32) throw new \Exception('int32 out of range');$this->responseType = $tmp;
    ...
    public function write($fp) {
      if ($this->responseType !== 0) {
        fwrite($fp, "\x08", 1);
        Protobuf::write_varint($fp, $this->responseType);
      }
    ...
    public function size() {
      $size = 0;
      if ($this->responseType !== 0) {
        $size += 1 + Protobuf::size_varint($this->responseType);
      }
      if ($this->unknown2 !== null) {
    ...
    public function clearResponseType() { $this->responseType = 0; }
    public function getResponseType() { return $this->responseType;}
    public function setResponseType($value) { $this->responseType = $value; }
    ...
    public function __toString() {
      return ''
           . Protobuf::toString('response_type', $this->responseType, 0)
