...
namespace POGOProtos\Settings\Master {
  ...
  final class ItemSettings extends ProtobufMessage {
    ...
    private $category = \POGOProtos\Enums\ItemCategory::ITEM_CATEGORY_NONE; // optional .POGOProtos.Enums.ItemCategory category = 3
    ...
    public function write($fp) {
      ...
      if ($this->category !== \POGOProtos\Enums\ItemCategory::ITEM_CATEGORY_NONE) {
        fwrite($fp, "\x18", 1);
    ...
    public function clearCategory() { $this->category = \POGOProtos\Enums\ItemCategory::ITEM_CATEGORY_NONE; }
    ...
    public function __toString() {
      return ''
           ...
           . Protobuf::toString('category', $this->category, \POGOProtos\Enums\ItemCategory::ITEM_CATEGORY_NONE)
